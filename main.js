...
/* Clock */
document.getElementById("clock").innerHTML = 'Built a real-time client-side clock with HTML, CSS, and JavaScript. It updates every second and improved my skills in timing and dynamic content.';
